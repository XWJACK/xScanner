...
- returns: checksum
*/
public func xCheckSum(buffer:UnsafeMutablePointer<Void>, var _ size:UInt16) -> UInt16 {
...
*/
public func xTimeSubtract(recvTimeStamp:UnsafeMutablePointer<timeval>, _ sendTimeStamp:UnsafeMutablePointer<timeval>) -> Double {
    //calculate seconds
...
*/
public func xSettingIp(ipAddr:in_addr_t, _ port:UInt16 , _ dstAddr:UnsafeMutablePointer<sockaddr_in>) {
