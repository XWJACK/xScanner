...
// */
//func xUDPSetting( socketfd: inout xSocket, _ ipAddress: xAddressInternet, _ port: xPort, _ destinationIpAddress: inout sockaddr_in) -> Bool {
//    //var sendTimeout = timeval(tv_sec: 0, tv_usec: 100)
//    socketfd = socket(PF_INET, SOCK_DGRAM, IPPROTO_UDP)
//    if socketfd == -1 {
//        assertionFailure(ScannerError.createSocketError.debugDescription)
//        return false
//    }
//
